...
$result = mysql_query("SELECT * FROM tblearthquakedetail");
...
// display pagination
echo "<p><a href='deleteAll.php'>delete All</a>";
echo "<p><a href='view.php'>View All</a> | <b>View Page:</b> ";
for ($i = 1; $i <= $total_pages; $i++)
{
    echo "<a href='tableEarthquake.php?page=$i'>$i</a> ";
}
echo "</p>";
...
for ($i = $start; $i < $end; $i++)
{
    ...
    echo "<tr>";
    echo '<td>' . mysql_result($result, $i, 'earthquakeId') . '</td>';
    echo '<td>' . mysql_result($result, $i, 'earthquakeDescription') . '</td>';
    echo '<td>' . mysql_result($result, $i, 'earthquakeTime') . '</td>';
    echo '<td>' . mysql_result($result, $i, 'earthquakeLongitude') . '</td>';
     echo '<td>' . mysql_result($result, $i, 'earthquakeLatitude') . '</td>';
     echo '<td>' . mysql_result($result, $i, 'eathquakeDepthValue') . '</td>';
  
    echo '<td><a href="deleteEarthquake.php?earthquakeId=' . mysql_result($result, $i, 'earthquakeId') . '">Delete</a></td>';
    echo "</tr>";
}
// close table>
echo "</table>";
